...
class TimescalePlotter:
    def __init__(self, time_values:list, label_values:list, filename:str, gold_label:str, color_map={'coughing': 'red', 'sneezing': 'blue', 'speech': 'green', 'silence': 'grey'}):
        data = {
            'Time': time_values,
            'Label': label_values
        }
        ...
        self.merged_intervals = self._merge_intervals()
